...
public class Item {
    ...
    // Người bán sản phẩm. Sử dụng @JsonIgnore để tránh vòng lặp tuần tự hóa hoặc trả thông tin nhạy cảm của User.
    @JsonIgnore
    @ManyToOne
    ...
    /**
     * Thuộc tính ảo "seller_username" khi tuần tự hóa JSON trả về cho Client.
     * Phương thức này trích xuất tên người bán từ thực thể User liên kết.
     */
