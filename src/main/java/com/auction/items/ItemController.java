...
/**
 * Controller chịu trách nhiệm xử lý các API REST liên quan đến sản phẩm đấu giá (Items).
 * Tất cả các yêu cầu cần phải có mã xác thực Bearer Token (JWT).
 */
...
public class ItemController {
    ...
    /**
     * API tạo mới và đăng bán một sản phẩm đấu giá.
     * POST /items
     *
    ...
    /**
     * API hủy bỏ một phiên đấu giá sản phẩm. Chỉ người bán mới có quyền thực hiện.
    ...
    /**
     * API lấy chi tiết thông tin của một sản phẩm qua mã ID.
     * GET /items/{itemId}
     *
    ...
    /**
     * API lấy danh sách toàn bộ sản phẩm trên hệ thống.
     * LƯU Ý: API này chỉ được sử dụng cho môi trường phát triển (development). Hãy xóa bỏ ở production.
     * GET /items/all
     *
    ...
    /**
     * API lấy danh sách các sản phẩm đang có phiên đấu giá hoạt động (chưa kết thúc), hỗ trợ phân trang.
    ...
    /**
     * API lấy danh sách các sản phẩm do một người dùng cụ thể đăng bán, hỗ trợ phân trang.
     * GET /items/listings/{username}?page=0&size=10
     *
