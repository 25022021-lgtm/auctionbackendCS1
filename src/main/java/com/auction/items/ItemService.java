...
/**
 * Service quản lý logic nghiệp vụ liên quan đến sản phẩm đấu giá (Items),
 * bao gồm đăng bán sản phẩm, hủy đấu giá, và truy vấn thông tin sản phẩm.
 */
@Service
public class ItemService {
    ...
    /**
     * Thực hiện nghiệp vụ hủy bỏ một phiên đấu giá sản phẩm đang hoạt động.
     * Hoàn lại số tiền cược cho người đặt giá cao nhất hiện tại (nếu có).
     *
    ...
    public BaseResponse cancelItem(Long itemId, String username) {
        ...
        // Nghiệp vụ hoàn tiền cược cho người trả giá cao nhất hiện tại (nếu họ không phải người bán và đã trả giá > 0)
