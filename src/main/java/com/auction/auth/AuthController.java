...
/**
 * Controller chịu trách nhiệm cung cấp các API liên quan đến Xác thực (Authentication)
 * và Phân quyền như Đăng ký, Đăng nhập, Đăng xuất và Làm mới Token.
 */
@RestController
@RequestMapping("")
public class AuthController {
    ...
    /**
     * API đăng nhập người dùng vào hệ thống.
     * POST /login
     *
    ...
    /**
     * API đăng xuất tài khoản khỏi hệ thống, thu hồi Refresh Token hiện tại.
     * POST /logout
     *
