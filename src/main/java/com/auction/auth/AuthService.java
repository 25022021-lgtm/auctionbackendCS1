...
/** Service handling authentication logic: registration, login, and token refresh. */
@Service
public class AuthService {
  ...
  public AuthResponse refreshingToken(String refreshToken) {
    ...
    AuthResponse response =
        new AuthResponse(true, "successfully refresh token", accessToken, newRefreshToken);
    return response;
  }
  ...
  public AuthResponse loginUser(LoginRequest request) {
    ...
    AuthResponse response =
        new AuthResponse(true, "Successfully logged in.", accessToken, refreshToken);
    return response;
  }
}
