...
/**
 * REST Controller cung cấp các API dành riêng cho quản trị viên (Admin).
 * Quản lý các hoạt động kiểm duyệt hệ thống: khóa người dùng (ban), mở khóa người dùng (unban)
 * và hủy bỏ phiên đấu giá sản phẩm vi phạm hoặc gặp sự cố.
 */
@RestController
...
public class AdminController {
    ...
    /**
     * API hủy bỏ một phiên đấu giá sản phẩm đang diễn ra.
    ...
    /**
     * API mở khóa tài khoản người dùng (Unban User) và thiết lập mật khẩu mới.
     * POST /admin/unban
     *
