...
/**
 * Lớp kết hợp thông tin (Wrapper DTO) chứa cả thông tin cược (Bid) và sản phẩm đấu giá (Item).
 * Được sử dụng để đóng gói và gửi đồng thời dữ liệu của hai đối tượng này về cho Client.
 */
