    ...
    /**
     * Lớp phản hồi API dạng đối tượng (Generic Wrapper Response), kế thừa từ BaseResponse.
     * Dùng để bọc dữ liệu trả về cho Client cùng với trạng thái và thông điệp.
     * 
