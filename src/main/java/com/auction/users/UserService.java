...
/**
 * Service quản lý các nghiệp vụ (Business Logic) liên quan đến người dùng,
 * bao gồm quản lý thông tin tài khoản và cập nhật số dư ví.
 */
@Service
public class UserService {
    ...
    /**
     * Lấy tham chiếu (Proxy Reference) của thực thể User theo tên đăng nhập.
     * Sử dụng getReferenceById giúp tránh truy vấn cơ sở dữ liệu nếu chỉ cần thiết lập quan hệ khóa ngoại (Foreign Key).
     * 
    ...
    /**
     * Trừ tiền trong tài khoản người dùng (khi thực hiện bid hoặc thanh toán) và cập nhật số dư mới qua Reactive Stream.
     * 
     * @param username Tên đăng nhập người dùng
