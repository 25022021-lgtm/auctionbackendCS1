...
/**
 * Thực thể AutoBid đại diện cho cấu hình tự động đặt giá (Auto-Bid) của một người dùng đối với một sản phẩm đấu giá.
 * Hệ thống sẽ tự động nâng giá cược khi có người cược cao hơn, cho tới khi chạm giới hạn maxBidLimit.
 */
@Entity
@Table(name = "autobids")
public class AutoBid {

    // Mã ID sản phẩm đấu giá (Khóa chính), mỗi sản phẩm tại một thời điểm chỉ có tối đa một cấu hình AutoBid hoạt động
    @Id
    @JsonIgnore
    @Column(name = "item_id")
    private Long itemId;
