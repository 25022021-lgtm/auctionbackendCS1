    ...
    public interface ItemStatusRepository extends JpaRepository<ItemStatus, Long> {
        ...
        /**
         * Tìm trạng thái sản phẩm bằng thực thể Item và áp dụng khóa ghi bi quan (Pessimistic Write Lock).
         * Ngăn chặn các luồng (thread) khác sửa đổi bản ghi này cùng lúc, đảm bảo an toàn luồng khi đặt giá cược.
         * 
